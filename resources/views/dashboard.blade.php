        ...
        <div class="row">
                ...
                <div class="card h-100 shadow-sm">
                    <div class="card-body px-4 py-4-5">
                        <div class="d-flex align-items-center">
                            <div class="stats-icon blue d-flex justify-content-center align-items-center">
            ...
            <div class="col-6 col-lg-3 col-md-6 mb-4">
                <div class="card h-100 shadow-sm">
                    <div class="card-body px-4 py-4-5">
                        <div class="d-flex align-items-center">
                            <div class="stats-icon green d-flex justify-content-center align-items-center">
            ...
            <div class="col-6 col-lg-3 col-md-6 mb-4">
                <div class="card h-100 shadow-sm">
                    <div class="card-body px-4 py-4-5">
                        <div class="d-flex align-items-center">
                            <div class="stats-icon purple d-flex justify-content-center align-items-center">
            ...
            <div class="col-6 col-lg-3 col-md-6 mb-4">
                <div class="card h-100 shadow-sm">
                    <div class="card-body px-4 py-4-5">
                        <div class="d-flex align-items-center">
                            <div class="stats-icon red d-flex justify-content-center align-items-center">
                            ...
                            <tbody>
                                @forelse ($bengkelTerbaru as $b)
                                    <tr>
                                        ...
                                        <td><span
                                                class="badge bg-light-primary text-primary">{{ $b->tipeLayanan->tipe ?? '-' }}</span>
                                        </td>
