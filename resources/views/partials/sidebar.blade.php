                ...
                <li class="sidebar-item has-sub">
                    ...
                    <ul class="submenu">
                        <li class="submenu-item">
                            <a href="{{ route('report.layanan') }}" target="_blank">Laporan Layanan</a>
                        </li>
                        <li class="submenu-item">
                            <a href="{{ route('report.bengkel') }}" target="_blank">Laporan Bengkel</a>
                        </li>
                        <li class="submenu-item">
                            <a href="{{ route('report.promo') }}" target="_blank">Laporan Promo</a>
                        </li>
                    </ul>
                </li>
